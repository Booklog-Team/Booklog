...
// ── 3단계: 김독서 shelf done 책 3권 추가 ─────────────────────────────────────

const KIM_UID = 'IcifW06lDnUeXepe3fJoOLbxZRm1';

const KIM_BOOKS = [
  {
    id: 'seed-vegemitarian-hanggang',
    title: '채식주의자',
    author: '한강',
    genre: '소설',
    totalPage: 247,
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=300&q=80',
    _startDate: '2026-01-20',
    _endDate: '2026-02-10',
  },
  {
    id: 'seed-tteokbokki-baeksehee',
    title: '죽고싶지만떡볶이는먹고싶어',
    author: '백세희',
    genre: '에세이',
    totalPage: 208,
    ...
    thumbnail: 'https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=300&q=80',
    _startDate: '2026-02-08',
    _endDate: '2026-02-20',
  },
  {
    id: 'seed-kimjiyoung-82-joenamju',
    title: '82년생 김지영',
    author: '조남주',
    genre: '소설',
    totalPage: 190,
    ...
    thumbnail: 'https://images.unsplash.com/photo-1516979187457-637abb4f9353?w=300&q=80',
    _startDate: '2026-02-23',
    _endDate: '2026-03-05',
  },
  {
    id: 'seed-selfish-gene-dawkins',
    title: '이기적 유전자',
    author: '리처드 도킨스',
    genre: '인문',
    totalPage: 544,
  ...
  {
    id: 'seed-convenience-store-kimhoyeon',
    title: '불편한 편의점',
    author: '김호연',
    genre: '소설',
    totalPage: 284,
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1476275466078-4007374efbbe?w=300&q=80',
    _startDate: '2026-03-24',
    _endDate: '2026-04-05',
  },
  {
    id: 'seed-adult-essay-unknown',
    title: '어른이 되면 괜찮을 줄 알았다',
    author: '저자미상',
    genre: '에세이',
    totalPage: 240,
    status: 'done',
    ...
    _startDate: '2026-04-04',
    _endDate: '2026-04-15',
  },
  {
    id: 'seed-atomic-habits-jamesclear',
    title: '아주 작은 습관의 힘',
    author: '제임스 클리어',
    genre: '자기계발',
    totalPage: 344,
  ...
  // ── want 도서 ────────────────────────────────────────────────────────────
  {
    ...
    rating: 0,
    lastReadDate: null,
    thumbnail: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?w=300&q=80',
    _checkedDates: [],
  },
  {
    id: 'seed-love-kyungae-kimgeumhee',
    title: '경애의 마음',
    author: '김금희',
    genre: '소설',
    totalPage: 288,
    ...
    rating: 0,
    lastReadDate: null,
    thumbnail: 'https://images.unsplash.com/photo-1509266272358-7701da638078?w=300&q=80',
    _checkedDates: [],
  },
  {
    id: 'seed-joseon-dynasty-parkyounggyu',
    title: '조선왕조실록',
    author: '박영규',
    genre: '역사',
    totalPage: 488,
    ...
    rating: 0,
    lastReadDate: null,
    thumbnail: 'https://images.unsplash.com/photo-1461360370896-922624d12aa1?w=300&q=80',
    _checkedDates: [],
  },
  {
    id: 'seed-consolation-philosophy-boethius',
    title: '철학의 위안',
    author: '보에티우스',
    genre: '인문',
    totalPage: 256,
    ...
    rating: 0,
    lastReadDate: null,
    thumbnail: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=300&q=80',
    _checkedDates: [],
  },
  {
    id: 'seed-demian-hesse',
    title: '데미안',
    author: '헤르만 헤세',
    genre: '소설',
    totalPage: 215,
    ...
    rating: 0,
    lastReadDate: null,
    thumbnail: 'https://images.unsplash.com/photo-1474932430478-367dbb6832c1?w=300&q=80',
    _checkedDates: [],
  },
  // ── reading 도서 ──────────────────────────────────────────────────────────
  {
    id: 'seed-pachinko-leeminjin',
    title: '파친코',
    author: '이민진',
    genre: '소설',
    totalPage: 560,
    ...
    thumbnail: 'https://images.unsplash.com/photo-1550399105-c4db5fb85c18?w=300&q=80',
  ...
  {
    id: 'seed-guns-germs-steel-diamond',
    title: '총, 균, 쇠',
    author: '재레드 다이아몬드',
    genre: '인문',
    totalPage: 752,
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=300&q=80',
    // Apr 6~25 중 18일 — Apr 9, Apr 16 skip → 연속 구간: 3·6·9일
    _checkedDates: [
      '2026-04-06','2026-04-07','2026-04-08',
      '2026-04-10','2026-04-11','2026-04-12','2026-04-13','2026-04-14','2026-04-15',
      '2026-04-17','2026-04-18','2026-04-19','2026-04-20','2026-04-21','2026-04-22','2026-04-23','2026-04-24','2026-04-25',
    ],
  },
];
...
async function seedKimShelf() {
  console.log('\n=== 3단계: 김독서 shelf 도서 추가 ===\n');

  for (const book of KIM_BOOKS) {
    const { _startDate, _endDate, _checkedDates, ...fields } = book;

    const ref  = db.collection('users').doc(KIM_UID).collection('shelf').doc(book.id);
    const snap = await ref.get();
    ...
    const checkedDates = _checkedDates ?? pickRandomDates(_startDate, _endDate, 10);

    await ref.set({ ...fields, checkedDates, memo: '' });
    console.log(`[CREATE] shelf/${book.id} (${book.title}) — checkedDates: ${checkedDates.join(', ')}`);
  }
}
...
const PARK_BOOKS = [
  ...
  {
    id: 'park-atomic-habits-jamesclear',
    title: '아주 작은 습관의 힘',
    author: '제임스 클리어',
    genre: '자기계발',
    totalPage: 344,
  ...
  {
    id: 'park-joseon-dynasty-parkyounggyu',
    title: '조선왕조실록',
    author: '박영규',
    genre: '역사',
    totalPage: 488,
    ...
    thumbnail: 'https://images.unsplash.com/photo-1461360370896-922624d12aa1?w=300&q=80',
    _startDate: '2026-03-08',
    _endDate: '2026-03-20',
  },
  {
    id: 'park-convenience-store-kimhoyeon',
    title: '불편한 편의점',
    author: '김호연',
    genre: '소설',
    totalPage: 284,
  ...
  // ── want 도서 ─────────────────────────────────────────────────────────────
  {
    id: 'park-kimjiyoung-82-joenamju',
    title: '82년생 김지영',
    author: '조남주',
    genre: '소설',
    totalPage: 190,
...
async function seedParkShelf() {
  console.log('\n=== 4단계: 박문학 shelf 도서 추가 ===\n');

  for (const book of PARK_BOOKS) {
    const { _startDate, _endDate, _checkedDates, ...fields } = book;

    const ref  = db.collection('users').doc(PARK_UID).collection('shelf').doc(book.id);
    const snap = await ref.get();
...
const LEE_BOOKS = [
  ...
  {
    id: 'lee-consolation-philosophy-boethius',
    title: '철학의 위안',
    author: '보에티우스',
    genre: '인문',
    totalPage: 256,
  ...
  // ── reading 도서 ──────────────────────────────────────────────────────────
  {
    id: 'lee-guns-germs-steel-diamond',
    title: '총, 균, 쇠',
    author: '재레드 다이아몬드',
    genre: '인문',
    totalPage: 752,
  ...
  {
    id: 'lee-atomic-habits-jamesclear',
    title: '아주 작은 습관의 힘',
    author: '제임스 클리어',
    genre: '자기계발',
    totalPage: 344,
...
async function seedLeeShelf() {
  console.log('\n=== 5단계: 이철학 shelf 도서 추가 ===\n');

  for (const book of LEE_BOOKS) {
    const { _startDate, _endDate, _checkedDates, ...fields } = book;

    const ref  = db.collection('users').doc(LEE_UID).collection('shelf').doc(book.id);
    const snap = await ref.get();
...
const BOARD_POSTS = [
  {
    ...
    title: '한강의 채식주의자를 읽고',
    content: '처음에는 단순한 채식 이야기인 줄 알았는데, 읽으면 읽을수록 인간의 욕망과 폭력성, 그리고 그 사이에서 무너져가는 한 여성의 이야기였어요. 특히 마지막 장 "나무 불꽃"은 몇 번을 다시 읽었습니다. 한강 작가의 문장은 짧지만 여운이 굉장히 길게 남는 것 같아요. 강추드립니다!',
    category: '독후감',
  ...
  },
  {
    ...
    content: '1월부터 매일 책을 읽기 시작한 지 벌써 3개월이 넘었어요. 중간에 이틀 빠진 적 있지만 그래도 꽤 잘 지키고 있는 것 같아요. 요즘은 잠들기 전 30분 독서가 습관이 됐습니다. 여러분은 어떤 방식으로 독서 루틴을 만드셨나요?',
    category: '자유',
    authorUid: 'IcifW06lDnUeXepe3fJoOLbxZRm1',
    authorName: '김독서',
  ...
  },
  {
    ...
    content: '이민진 작가의 파친코는 일제강점기부터 1980년대까지 재일 한국인 가족 4대의 이야기를 담고 있습니다. "역사가 우리를 망쳐도 그래도 상관없다"는 첫 문장이 계속 머릿속에 맴돌아요. 선자라는 캐릭터가 너무 생생해서 마지막 장을 닫고 나서 한참을 멍하니 있었습니다. 꼭 읽어보세요.',
    category: '독후감',
  ...
  },
  {
    ...
    content: '아주 작은 습관의 힘 읽고 정말 삶이 달라진 것 같아서 비슷한 책을 찾고 있어요. 이론보다는 바로 실천할 수 있는 내용 위주의 자기계발서가 있으면 추천 부탁드립니다. 원씽은 이미 읽었고요, 다음 책 고르는 중입니다!',
    category: '질문',
    authorUid: 'LmOvpryRYLP3Th314zl69tQQm1j2',
    authorName: '박문학',
  ...
  },
  {
    ...
    content: '고등학교 때 읽었을 때는 그냥 성장소설이구나 싶었는데, 지금 다시 읽으니 완전히 다르게 느껴졌어요. "새는 알에서 나오려고 투쟁한다. 알은 세계다." 이 문장 하나로 책 전체가 정리되는 것 같았습니다. 철학적으로 자아 정체성에 대해 고민하는 분들에게 꼭 권해드리고 싶은 책이에요.',
    category: '독후감',
...
async function seedBoardPosts() {
  ...
  for (const post of BOARD_POSTS) {
    ...
    console.log(`[CREATE] board/${id} (${fields.authorName}) — "${fields.title}"`);
  }
}
...
const MEETINGS = [
  {
    ...
    title:       '한강 소설 완독 챌린지',
    description: '한강 작가의 소설을 함께 읽고 이야기 나누는 모임입니다. 매주 한 작품씩 읽고 감상을 공유해요.',
    currentBook: '채식주의자',
    pageRange:   'p.1 ~ 247',
    deadline:    '2026-05-15',
    maxMembers:  10,
    ...
    hostName:    '김독서',
    members:     ['IcifW06lDnUeXepe3fJoOLbxZRm1', 'LmOvpryRYLP3Th314zl69tQQm1j2', '5kf1UAvpWUbUdSluRJzhupBEWXf2'],
    createdAt:   admin.firestore.Timestamp.fromDate(new Date('2026-04-20')),
  },
  {
    id:          'seed-meeting-humanities',
    title:       '인문학 탐구 독서 모임',
    description: '사피엔스, 총균쇠 등 인문·역사 분야의 묵직한 책을 함께 읽습니다. 깊이 있는 토론을 좋아하시는 분 환영해요!',
    currentBook: '총, 균, 쇠',
    pageRange:   'p.1 ~ 200',
    deadline:    '2026-05-20',
    maxMembers:  8,
  ...
  },
  {
    ...
    title:       '자기계발 함께 읽기',
    description: '아주 작은 습관의 힘, 원씽 등 실천 중심 자기계발서를 같이 읽고 실제 삶에 적용하는 인사이트를 나눠요.',
...
async function seedMeetings() {
  ...
  for (const meeting of MEETINGS) {
    ...
    console.log(`[CREATE] meetings/${id} — "${fields.title}" (${fields.members.length}명 참여)`);
  }
}
