...
export const MOCK_BOOKS = [
  {
    ...
    genre: ["소설", "문학"],
    description:
      "평범한 가정주부 영혜가 어느 날 갑자기 채식주의자가 되기로 결심하면서 벌어지는 이야기. 세 편의 연작 소설로 구성된 이 작품은 폭력과 억압, 그리고 자유를 향한 욕망을 그린다.",
    totalPages: 247,
    currentPage: 180,
    status: "reading",
  ...
  },
  {
    ...
    checkedDates: ["2026-04-15", "2026-04-17", "2026-04-19", "2026-04-21"],
  },
  {
    id: "11",
    title: "해의 계절",
...
export const MOCK_POSTS = [
  ...
  },
  {
    ...
    content:
      "최근 SF에 관심이 생겼는데 어떤 책부터 시작하면 좋을까요? 한국 SF도 좋고 외국 SF도 좋습니다.",
