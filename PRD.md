...
| GitHub | https://github.com/minseo9451/Booklog |
...
│   │   │
│   │   ├── pages/
│   │   │   ├── Onboarding.jsx          # 01 온보딩 (Manus 기본 있음)
│   │   │   ├── Auth.jsx                # 02 로그인/회원가입 (Manus 기본 있음)
│   │   │   ├── Main.jsx                # 03 메인
│   │   │   ├── Search.jsx              # 04 검색
│   │   │   ├── BookDetail.jsx          # 05 도서 상세
│   │   │   ├── Library.jsx             # 06 서재 + 캘린더 (Manus 기본 있음)
│   │   │   ├── Profile.jsx             # 07 프로필 (Manus 기본 있음)
│   │   │   ├── Meeting.jsx             # 08 독서 모임
│   │   │   ├── Board.jsx               # 09 자유 게시판
│   │   │   ├── Points.jsx              # 10 포인트 & 기부 (Manus 기본 있음)
│   │   │   └── NotFound.jsx            # 404 (Manus 기본 있음)
│   │   │
│   │   ├── components/
│   │   │   ├── TopNav.jsx              # 상단 네비 (Manus 제공)
│   │   │   ├── SideNav.jsx             # 사이드 네비 (Manus 제공)
│   │   │   ├── BottomNav.jsx           # 하단 탭 모바일 (Manus 제공)
│   │   │   ├── PageLayout.jsx          # 레이아웃 래퍼 (Manus 제공)
...
| 팀원 | 담당 | 페이지 |
|------|------|--------|
| 준화 (A) | 메인/검색/도서상세 | Main, Search, BookDetail, BookCard, utils/api.js |
| 민서 (B) | 인증/온보딩/포인트 | Auth, Onboarding, Points, firebase/, PrivateRoute |
| 에진 (C) | 서재/커뮤니티/프로필 | Library, Profile, Meeting, Board, contexts/ |

### 각자 첫 번째 작업
- **준화**: `feature/junhwa-main` 브랜치 → utils/api.js 먼저 작성 후 Main 시작
- **민서**: `feature/minseo-auth` 브랜치 → firebase/config.js → Auth 페이지
- **에진**: `feature/ejin-context` 브랜치 → AuthContext, ShelfContext, PointContext 먼저
...
[ ] STEP B-02. PrivateRoute.jsx 작성
[ ] STEP B-03. AuthContext.jsx 작성
...
# 준화 (A) — 메인/검색/도서상세
[ ] STEP A-01. utils/api.js 작성
[ ] STEP A-02. BookCard.jsx 작성
[ ] STEP A-03. Main.jsx 구현
[ ] STEP A-04. Search.jsx 구현
[ ] STEP A-05. BookDetail.jsx + StatusButtons + ReadingTracker

# 에진 (C) — 서재/커뮤니티/프로필
[ ] STEP C-01. ShelfContext.jsx + PointContext.jsx 작성
[ ] STEP C-02. Library.jsx + ReadingCalendar 구현
[ ] STEP C-03. Profile.jsx 구현
[ ] STEP C-04. Meeting.jsx 구현
[ ] STEP C-05. Board.jsx 구현
